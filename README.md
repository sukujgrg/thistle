...
A Mac app that talks to Gotenberg. It can boot the full Gotenberg image on Apple silicon without Docker, or send requests to a Gotenberg API you already run.
